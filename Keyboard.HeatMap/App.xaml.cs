        ...
        void App_Startup(object sender, StartupEventArgs e)
        {
            ...
            if (e.Args.Length == 1)
            {
                switch (e.Args[0])
                {
                    ...
                    case "-week": StartQueryTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 8, 0, 0); break;
                    ...
                    case "-ten": StartQueryTime = new DateTime(DateTime.Now.Year - 10, DateTime.Now.Month, DateTime.Now.Day, 8, 0, 0); break;
                    default:
                        break;
                }
            }
